...
SELECT nombre AS Nombre_de_producto, precio AS euros, round(precio*1.09, 2) AS dolars FROM producto;
SELECT UPPER(nombre) AS Nombre_de_producto, precio FROM producto;
SELECT LOWER(nombre) AS Nombre_de_producto, precio FROM producto;
