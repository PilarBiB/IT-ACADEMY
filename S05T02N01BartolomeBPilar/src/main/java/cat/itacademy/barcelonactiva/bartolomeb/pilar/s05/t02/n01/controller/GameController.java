...
public class GameController {
	...
	public ResponseEntity<String> guardarGame(@PathVariable("id") Integer id) throws GameException {
		return new ResponseEntity<>(gameService.guardarGame(id), HttpStatus.OK);
	}

	@DeleteMapping("/players/{id}/games")
	public ResponseEntity<String> deleteGames(@PathVariable("id") Integer id) {
		gameService.borrarByPlayerId(id);
		return new ResponseEntity<String>("Juego Borrado", HttpStatus.OK);
	}

	@GetMapping("/players/{id}/games")
	public ResponseEntity<List<Game>> eliminarGames(@PathVariable("id") Integer id) {
