...
SELECT DISTINCT apellido1, apellido2, persona.nombre, departamento.nombre FROM persona, profesor, departamento WHERE tipo= 'profesor' AND persona.id= profesor.id_profesor AND departamento.id= profesor.id_departamento ORDER BY apellido1, apellido2, persona.nombre;
SELECT asignatura.nombre, anyo_inicio, anyo_fin FROM persona, alumno_se_matricula_asignatura, curso_escolar , asignatura WHERE nif LIKE '26902806M' AND PERSONA.id = alumno_se_matricula_asignatura.id_alumno AND alumno_se_matricula_asignatura.id_curso_escolar=curso_escolar.id AND alumno_se_matricula_asignatura.id_asignatura=asignatura.id; 
SELECT DISTINCT DEPARTAMENTO.nombre FROM grado, asignatura, profesor, departamento WHERE grado.nombre= 'Grado en Ingenieria Informatica (Plan 2015)' AND grado.id= asignatura.id_grado AND asignatura.id_profesor= profesor.id_profesor AND profesor.id_departamento= departamento.id;
SELECT DISTINCT persona.nombre, apellido1, apellido2 FROM persona, alumno_se_matricula_asignatura, curso_escolar WHERE alumno_se_matricula_asignatura.id_alumno= persona.id AND alumno_se_matricula_asignatura.id_curso_escolar=curso_escolar.id AND curso_escolar.anyo_inicio= 2018;

SELECT departamento.nombre AS departamento, apellido1, apellido2, persona.nombre FROM departamento RIGHT JOIN profesor ON profesor.id_departamento= departamento.id INNER JOIN  persona ON profesor.id_profesor= persona.id ORDER BY departamento.nombre, apellido1, apellido2, persona.nombre; 
SELECT departamento.nombre AS departamento, apellido1, apellido2, persona.nombre FROM departamento RIGHT JOIN profesor ON profesor.id_departamento= departamento.id INNER JOIN  persona ON profesor.id_profesor= persona.id WHERE departamento.nombre IS NULL ORDER BY departamento.nombre, apellido1, apellido2, persona.nombre; 
SELECT departamento.nombre AS departamento FROM departamento LEFT JOIN profesor ON profesor.id_departamento= departamento.id WHERE profesor.id_profesor IS NULL ORDER BY departamento.nombre; 
SELECT DISTINCT apellido1, apellido2, persona.nombre FROM persona INNER JOIN profesor ON profesor.id_profesor= persona.id  RIGHT JOIN asignatura ON asignatura.id_profesor= profesor.id_profesor WHERE persona.nombre IS NOT NULL;
SELECT asignatura.id, asignatura.nombre AS asignatura FROM asignatura LEFT JOIN profesor ON asignatura.id_profesor= profesor.id_profesor WHERE asignatura.id_profesor IS NULL;
(SELECT DISTINCT departamento.nombre AS departamento FROM departamento  LEFT JOIN profesor ON departamento.id= profesor.id_departamento WHERE profesor.id_profesor IS NULL) UNION (SELECT DISTINCT departamento.nombre AS departamento FROM departamento INNER JOIN profesor ON departamento.id= profesor.id_departamento LEFT JOIN asignatura ON asignatura.id_profesor= profesor.id_profesor WHERE asignatura.id_profesor IS NULL);

SELECT COUNT(*) AS nº_alumnes FROM persona WHERE tipo= 'alumno';
SELECT COUNT(*) AS nº_alumnes_del_1999 FROM persona WHERE tipo= 'alumno' AND YEAR (fecha_nacimiento)= 1999;
SELECT departamento.nombre, COUNT(profesor.id_profesor) AS nº_prof_assoc FROM departamento,profesor WHERE profesor.id_departamento= departamento.id GROUP BY departamento.nombre ORDER BY COUNT(*) DESC;
SELECT departamento.nombre, COUNT(profesor.id_profesor) AS nº_prof_assoc FROM departamento LEFT JOIN profesor ON profesor.id_departamento= departamento.id GROUP BY departamento.id ORDER BY COUNT(*) DESC;
SELECT grado.nombre, COUNT(asignatura.id) AS nº_asignaturas FROM grado LEFT JOIN asignatura ON asignatura.id_grado= grado.id GROUP BY grado.id ORDER BY COUNT(*) DESC;